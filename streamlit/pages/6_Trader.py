...
summary_path = "backtrack/summary/stats_dca.json"
...
html_path = "backtrack/plots/backtest_dca.html"
with open(html_path, "r") as f:
    html = f.read()
st.subheader("Equity Curve")
st.components.v1.html(html, height=800, width=1600, scrolling=False)
